    ...
    <ModalWindow open={isModalOpen} onClose={modalClose} modalContent={currentModalContent} />
        ...
        <Box className="flex flex-col justify-center items-center height-full-mobile-support">
          ...
          <Paper elevation={0} className='flex flex-col justify-center items-center' sx={{height: '100%', width: '100%'}} square>
            ...
            { mode === 'dark' ? <motion.img src='src\assets\m-logo-white.png' className="m-4" alt="logo" {...bounce} {...scaleOnHover} /> : <motion.img src='src\assets\m-logo-black.png' className="m-4" alt="logo" {...bounce} {...scaleOnHover} /> }
            <div className="text-center">
              ...
              <Grid container spacing={{xs: 2, sm: 0}}>
                <Grid size={{xs: 12, sm: 3.5}}>
                  <Button variant="contained" component={motion.button} {...scaleOnHover} sx={{p: 1.4}} onClick={() => modalOpen(newModalContent.newGame)}>Nowa gra</Button>
                </Grid>
                <Grid size={{xs: 12, sm: 5}}>
                  <Button variant="contained" component={motion.button} {...scaleOnHover} sx={{p: 1.4}} onClick={() => modalOpen(newModalContent.joinGame)}>Dołącz do gry</Button>
                </Grid>
                <Grid size={{xs: 12, sm: 3.5}}>
                  <Button variant="contained" component={motion.button} {...scaleOnHover} sx={{p: 1.4}} onClick={() => modalOpen(newModalContent.instruction)}>Instrukcja</Button>
                </Grid> 
              </Grid>
