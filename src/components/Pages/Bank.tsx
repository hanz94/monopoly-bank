    ...
    const location = useLocation();
        ...
        return (
            <div style={{ width: '90%', height: '100%' }}>
                ...
                {dbPlayersInfo && Object.keys(dbPlayersInfo).length > 0 ? (
                    <>
                    {(dbPlayersInfo[location.state?.playerCode]?.isBank === 'owner' || dbPlayersInfo[location.state?.playerCode]?.isBank === 'true') ? (
                        <>
                    ...
                    ) : dbPlayersInfo[location.state?.playerCode]?.isBank === 'false' ? (
                        <>
                            <Typography sx={{ mt: 2, mb: 1, textAlign: 'center' }}>Brak uprawnień.</Typography>
                            <Typography sx={{ mt: 2, mb: 1, textAlign: 'center' }}>Nie posiadasz dostępu do strony Banku.</Typography>
                        </>
                    ) : (
                        <CircularProgress sx={{ mt: 2, mx: 'auto' }} />
                    )
                    }
